...
//SSL
        ...
        RequestSpecification reqAddProduct = given().relaxedHTTPSValidation().log().all().spec(addProductBaseReq).param("productName", "Laptop")
                .param("productAddedBy", userId).param("productCategory", "fashion")
                .param("productSubCategory", "shirts").param("productPrice", "11500")
                .param("productDescription", "Lenova").param("productFor", "men")
                .multiPart("productImage",new File("D:\\laptop.png"));
...
//Delete Product
        ...
        RequestSpecification deleteProdReq =given().relaxedHTTPSValidation().log().all().spec(deleteProdBaseReq).pathParam("productId",productId);
